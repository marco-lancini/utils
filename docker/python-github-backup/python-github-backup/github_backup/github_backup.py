...
def parse_args(args = None):
    ...
    parser.add_argument('-z',
                        ...
                        default='.',
                        dest='output_zip',
                        help='directory at which to save the final ZIP file')
...
def filter_repositories(args, unfiltered_repositories):
    ...
    repositories = []
    log_info('List of repositories BEFORE filtering:')
    ...
    log_info('List of repositories AFTER filtering:')
...
def backup_repositories(args, output_directory, repositories):
    log_info(f'Backing up repositories to: {output_directory}')
    ...
    for repository in repositories:
        log_info(f"Backing up repository: {repository['name']}")
        if repository.get('is_gist'):
