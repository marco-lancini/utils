    ...
    return (
      this.each(function (b) {
        ...
        if (!d || (d && 0 === d.length)) {
          ...
          k && 'none' !== k
            ? (d = [{url: h.css('backgroundImage').replace(/url\(|\)|"|'/g, '')}])
  ...
  var f = {
    ...
    k = function (a, e) {
      return (
        (a.centeredX || a.centeredY) &&
          (b.console &&
            b.console.log &&
            b.console.log('jquery.backstretch: `centeredX`/`centeredY` is deprecated, please use `alignX`/`alignY`'),
          a.centeredX && (a.alignX = 0.5),
          a.centeredY && (a.alignY = 0.5)),
        a.speed !== c &&
          (b.console &&
            b.console.log &&
            b.console.log('jquery.backstretch: `speed` is deprecated, please use `transitionDuration`'),
    ...
    l = function (a, b) {
      return (
        'left' === a.alignX
          ...
          : 'right' === a.alignX
          ? (a.alignX = 1)
          : (a.alignX !== c || b) && ((a.alignX = parseFloat(a.alignX)), isNaN(a.alignX) && (a.alignX = 0.5)),
        'top' === a.alignY
          ? (a.alignY = 0)
          : 'center' === a.alignY
          ? (a.alignY = 0.5)
          : 'bottom' === a.alignY
          ? (a.alignY = 1)
          : (a.alignX !== c || b) && ((a.alignY = parseFloat(a.alignY)), isNaN(a.alignY) && (a.alignY = 0.5)),
        a
      );
    },
    ...
    n = function (c, d, e) {
      ...
      if (
        ...
        if (!this.isBody) {
          ...
          this.$container.css({position: 'static' === m ? 'relative' : m, zIndex: 'auto' === n ? 0 : n}),
    ...
    o = function (b) {
      ...
      switch (d.toString().toLowerCase()) {
        default:
        case 'fade':
          e.fadeIn({duration: b.duration, complete: b.complete, easing: b.easing || c});
          break;
        case 'fadeinout':
        case 'fade_in_out':
          var g = function () {
          ...
          f.length ? f.fadeOut({duration: b.duration / 2, complete: g, easing: b.easing || c}) : g();
          break;
        case 'pushleft':
        case 'push_left':
        case 'pushright':
  ...
  n.prototype = {
    resize: function () {
      try {
        ...
        if (
          (f !== this._lastResizeContainerWidth || h !== this._lastResizeContainerHeight) &&
          (Math.abs(j - 1) >= l || isNaN(j) || Math.abs(k - 1) >= l || isNaN(k)) &&
    ...
    show: function (b, d) {
      if (!(Math.abs(b) > this.images.length - 1)) {
        ...
        return (
          l
            ? ((e.videoWrapper = new p(k)), (e.$item = e.videoWrapper.$video.css('pointer-events', 'none')))
            : (e.$item = a('<img />')),
          ...
          e.$item.bind(l ? 'canplay' : 'load', function (f) {
            ...
            (e.firstShow && !e.options.animateFirst) || !t || !r
              ? (k.show(), u())
              : o({new: k, old: g, transition: r, duration: t, easing: s, complete: u}),
              (e.firstShow = !1),
              e.resize();
          }),
  ...
  (p.prototype.init = function (d) {
    ...
    if ((d.url instanceof Array || !e.test(d.url) || (i = 'youtube'), (g.type = i), 'youtube' === i)) {
      ...
      (g.__ytStartMuted = !!d.mute || d.mute === c),
        (f = a('<iframe />').attr({src_to_load: j}).css({border: 0, margin: 0, padding: 0}).data('player', g)),
        d.loop &&
    ...
    (p.prototype.play = function () {
      ...
      return (
        ...
        'youtube' === a.type ? a.ytReady && (a.$video.trigger('play'), a.ytPlayer.playVideo()) : a.video.play(),
        a
      );
    }),
    (p.prototype.pause = function () {
      var a = this;
      return (
        (a.__manuallyStopped = !1), 'youtube' === a.type ? a.ytReady && a.ytPlayer.pauseVideo() : a.video.pause(), a
      );
    }),
    ...
    (p.loadYoutubeAPI = function () {
      (b.YT && b.__yt_load_event_interval__) ||
        (b.YT ||
          ...
          a('<script type="text/javascript" src="https://www.youtube.com/iframe_api">').appendTo('body'),
  ...
  var q = function () {
    ...
    s = (function () {
      var a = navigator.userAgent,
        ...
        k = !!j && j[1];
      return !(
        ((c.indexOf('iPhone') > -1 || c.indexOf('iPad') > -1 || c.indexOf('iPod') > -1) && e && e < 534) ||
