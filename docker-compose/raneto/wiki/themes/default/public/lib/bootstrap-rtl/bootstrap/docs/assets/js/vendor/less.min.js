...
!(function (a, b) {
  ...
  function g(a, b, c) {
    ...
    if ((h && i === !1 && h.parentNode.removeChild(h), j.styleSheet))
      try {
  ...
  function i(a, c) {
    ...
    a.extract
      ? (n(a, 0, ''),
        n(a, 1, 'line'),
        n(a, 2, ''),
        (f += 'on line ' + a.line + ', column ' + (a.column + 1) + ':</p><ul>' + k.join('') + '</ul>'))
  ...
  function s(b, c, d, e) {
    ...
    if (
      (c
        ? ((h.entryPath = c.entryPath),
          (h.rootpath = c.rootpath),
          (h.rootFilename = c.rootFilename),
          (h.relativeUrls = c.relativeUrls))
        : ((h.entryPath = f.path),
          (h.rootpath = w.rootpath || f.path),
          (h.rootFilename = g),
          (h.relativeUrls = e.relativeUrls)),
      h.relativeUrls && (h.rootpath = e.rootpath ? o(e.rootpath + p(f.path, h.entryPath)).path : f.path),
      e.useFileCache && E[g])
    )
      try {
        var i = E[g];
      ...
      s(
        ...
        function (h, i, j, k, l) {
          if (l) {
            ...
            if (!c && o && l.lastModified && new Date(l.lastModified).valueOf() === new Date(o).valueOf())
              return g(n, a), (l.local = !0), void b(null, null, i, a, l, j);
          }
          m(j),
            i
              ? ((f.currentFileInfo = k),
                new w.Parser(f).parse(
                  i,
                  function (c, d) {
                  ...
                  {modifyVars: e, globalVars: w.globalVars}
                ))
              : b(h, null, null, a, l, j);
        },
        f,
  ...
  w === b && ((w = exports), (x = c('./tree')), (w.mode = 'node')),
    (w.Parser = function (a) {
      ...
      function i(a) {
        ...
        return 'string' === d
          ? v.charAt(y) !== a
            ...
            : (l(1), a)
          : (g(),
            (b = a.exec(C)) ? ((c = b[0].length), l(c), 'string' == typeof b ? b : 1 === b.length ? b[0] : b) : null);
      }
      function j(a) {
        y > D && ((C = C.slice(y - D)), (D = y));
        var b = a.exec(C);
      ...
      function l(a) {
        for (
          var b, c = y, d = z, e = y - D, f = y + C.length - e, g = (y += a), h = v;
          f > y && ((b = h.charCodeAt(y)), !(b > 32)) && (32 === b || 10 === b || 9 === b || 13 === b);
          y++
        );
        return (
          (C = C.slice(a + y - g + e)),
      ...
      function m(a, b) {
        ...
        return c
          ? c
          : void o(b || ('string' == typeof a ? "expected '" + a + "' got '" + v.charAt(y) + "'" : 'unexpected token'));
      }
      function n(a, b) {
      ...
      function t(a, b, d) {
        ...
        return (
          'browser' !== w.mode && 'rhino' !== w.mode && (e = c('path').resolve(e)),
          {lineNumber: s(a, b).line + 1, fileName: e}
        );
      }
      function u(a, b) {
        var c = r(a, b),
      ...
      return (
        ...
        (E = {
          ...
          parse: function (d, e, f) {
            ...
            if (
              ((y = z = D = A = 0),
              (j = f && f.globalVars ? w.Parser.serializeVars(f.globalVars) + '\n' : ''),
              (k = f && f.modifyVars ? '\n' + w.Parser.serializeVars(f.modifyVars) : ''),
              (j || (f && f.banner)) &&
                ((m = (f && f.banner ? f.banner : '') + j),
                (E.imports.contentsIgnoredChars[a.currentFileInfo.filename] = m.length)),
              (d = d.replace(/\r\n/g, '\n')),
              (v = d = m + d.replace(/^\uFEFF/, '') + k),
              (E.imports.contents[a.currentFileInfo.filename] = d),
              (B = (function (b) {
                function c(b, c) {
                ...
                var e,
                  ...
                  s = 0;
                for (i = 0; o > i; i++)
                  if (((k = b.charCodeAt(i)), !((k >= 97 && 122 >= k) || 34 > k)))
                    switch (k) {
                      case 40:
                        q++, (f = i);
                        continue;
                      ...
                      case 47:
                        ...
                        if (((m = b.charCodeAt(i + 1)), 47 == m))
                          ...
                          for (
                            g = j = i, i += 2;
                            o - 1 > i &&
                            ((m = b.charCodeAt(i)), 125 == m && (h = i), 42 != m || 47 != b.charCodeAt(i + 1));
                            i++
                          );
                ...
                return function (e, f) {
                    ...
                    ((f = Object.keys(f).map(function (a) {
                      ...
                      return (
                        b instanceof x.Value ||
                          (b instanceof x.Expression || (b = new x.Expression([b])), (b = new x.Value([b]))),
                  ...
                  try {
                    var j,
                      k = [],
                      l = [
                        new x.joinSelectorVisitor(),
                        new x.processExtendsVisitor(),
                        new x.toCSSVisitor({compress: Boolean(e.compress)}),
                      ],
                      m = this;
                    if (e.plugins)
                      for (j = 0; j < e.plugins.length; j++)
                        e.plugins[j].isPreEvalVisitor
                          ? k.push(e.plugins[j])
                          : e.plugins[j].isPreVisitor
                          ? l.splice(0, 0, e.plugins[j])
                          : l.push(e.plugins[j]);
                    for (j = 0; j < k.length; j++) k[j].run(m);
                    for (g = d.call(m, i), j = 0; j < l.length; j++) l[j].run(g);
                    e.sourceMap &&
                      (g = new x.sourceMapOutput({
                  ...
                  if (e.cleancss && 'node' === w.mode) {
                    var o = c('clean-css'),
                      p = e.cleancssOptions || {};
                    return (
                      p.keepSpecialComments === b && (p.keepSpecialComments = '*'),
                      (p.processImport = !1),
                      (p.noRebase = !0),
          ...
          parsers: (F = {
            ...
            comment: function () {
              ...
              if ('/' === v.charAt(y))
                return '/' === v.charAt(y + 1)
                  ? new x.Comment(j(/^\/\/.*/), !0, y, a.currentFileInfo)
                  : ((b = j(/^\/\*(?:[^*]|\*+[^\/*])*\*+\/\n?/)),
            ...
            entities: {
              quoted: function () {
                ...
                return (
                  '~' === v.charAt(d) && (d++, (c = !0)),
                  '"' === v.charAt(d) || "'" === v.charAt(d)
                    ? (c && k('~'),
                      (b = j(/^"((?:[^"\\\r\n]|\\.)*)"|'((?:[^'\\\r\n]|\\.)*)'/)),
                      b ? new x.Quoted(b[0], b[1] || b[2], c, e, a.currentFileInfo) : void 0)
                    : void 0
                );
              },
              keyword: function () {
              ...
              url: function () {
                var b;
                if ('u' === v.charAt(y) && j(/^url\(/))
                  return (
                    (b = this.quoted() || this.variable() || j(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/) || ''),
                    n(')'),
              ...
              dimension: function () {
                ...
                if (!(b > 57 || 43 > b || 47 === b || 44 == b))
                  return (a = j(/^([+-]?\d*\.?\d+)(%|[a-z]+)?/)), a ? new x.Dimension(a[1], a[2]) : void 0;
              },
                ...
                return (
                  ...
                  '`' === v.charAt(e)
                    ? (a.javascriptEnabled === b ||
                        a.javascriptEnabled ||
                        o('You are using JavaScript, which has been disabled.'),
                      d && k('~'),
                      (c = j(/^`([^`]*)`/)),
                      c ? new x.JavaScript(c[1], y, d) : void 0)
                    : void 0
                );
              },
            },
              ...
              if (j(a ? /^&:extend\(/ : /^:extend\(/)) {
                do {
                  for (d = null, b = null; !(d = j(/^(all)(?=\s*(\)|,))/)) && (c = this.element()); )
                    b ? b.push(c) : (b = [c]);
                  (d = d && d[1]),
                    b || o('Missing target selector for :extend().'),
                    (f = new x.Extend(new x.Selector(b), d, g)),
                    e ? e.push(f) : (e = [f]);
                } while (k(','));
                return m(/^\)/), a && m(/^;/), e;
              }
            ...
            mixin: {
              call: function () {
                ...
                if ('.' === m || '#' === m) {
                  ...
                  return c && (k('(') && ((l = this.args(!0).args), n(')')), F.important() && (o = !0), F.end())
                    ? (f(), new x.mixin.Call(c, l, p, a.currentFileInfo, o))
                    : void e();
                }
              },
              args: function (a) {
                ...
                for (d(); ; ) {
                  ...
                  if ((a ? l.value && 1 == l.value.length && (t = l.value[0]) : (t = l), t && t instanceof x.Variable))
                    if (k(':')) {
                      if (
                        (q.length > 0 && (b && o('Cannot mix ; and , as delimiter types'), (c = !0)),
                        (i = (a && m.detachedRuleset()) || m.expression()),
                        !i)
                      ) {
                  ...
                  i && q.push(i),
                    s.push({name: h, value: i}),
                    k(',') ||
                      ((k(';') || b) &&
                        (c && o('Cannot mix ; and , as delimiter types'),
                        (b = !0),
                        q.length > 1 && (i = new x.Value(q)),
                        r.push({name: g, value: i}),
                        (g = null),
                        (q = []),
                        (c = !1)));
                }
              ...
              definition: function () {
                ...
                if (!(('.' !== v.charAt(y) && '#' !== v.charAt(y)) || p(/^[^{]*\}/)))
                  if ((d(), (b = j(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)))) {
                    ...
                    if ((F.comments(), j(/^when/) && (g = m(F.conditions, 'expected condition')), (c = F.block())))
                      return f(), new x.mixin.Definition(a, h, c, g, i);
                    e();
                  } else f();
              },
            },
            entity: function () {
              var a = this.entities;
              return (
                a.literal() || a.variable() || a.url() || a.call() || a.keyword() || a.javascript() || this.comment()
              );
            },
            end: function () {
              return k(';') || q('}');
            ...
            alpha: function () {
              var a;
              if (j(/^\(opacity=/i))
                return (a = j(/^\d+/) || this.entities.variable()), a ? (n(')'), new x.Alpha(a)) : void 0;
            },
            element: function () {
              var b,
                c,
              ...
              return (
                ...
                (b =
                  j(/^(?:\d+\.\d+|\d+)%/) ||
                  j(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) ||
                  k('*') ||
                  k('&') ||
                  this.attribute() ||
                  j(/^\([^()@]+\)/) ||
            ...
            selector: function (b) {
              for (
                var c, d, e, f, g, h, i, j = y, k = J;
                ((b && (g = this.extend())) || (b && (h = k(/^when/))) || (f = this.element())) &&
                (h
                  ? (i = m(this.conditions, 'expected condition'))
                  : i
                  ...
                  ? d
                    ? d.push(g)
                    : (d = [g])
                  : (d && o('Extend can only be used at the end of selector'),
                    (e = v.charAt(y)),
                    c ? c.push(f) : (c = [f]),
                    (f = null)),
                '{' !== e && '}' !== e && ';' !== e && ',' !== e && ')' !== e);
              ...
              return c
                ? new x.Selector(c, d, i, j, a.currentFileInfo)
                : void (d && o('Extend must be used to extend a selector, it cannot be used on its own'));
            },
            attribute: function () {
              if (k('[')) {
                var a,
                  ...
                  d = this.entities;
                return (
                  (a = d.variableCurly()) || (a = m(/^(?:[_A-Za-z0-9-\*]*\|)?(?:[_A-Za-z0-9-]|\\.)+/)),
                  (c = j(/^[|~*$^]?=/)),
            ...
            ruleset: function () {
              ...
              for (d(), a.dumpLineNumbers && (h = t(y, v, a)); ; ) {
                ...
                if (
                  (b ? b.push(c) : (b = [c]),
                  this.comments(),
                  c.condition && b.length > 1 && o('Guards are only currently allowed on a single selector.'),
                  !k(','))
                )
                  break;
              ...
              if ('.' !== l && '#' !== l && '&' !== l)
                if ((d(), (c = this.variable() || this.ruleProperty()))) {
                  if (
                    ...
                    return f(), new x.Rule(c, g, h, i, k, a.currentFileInfo);
            ...
            anonymousValue: function () {
              var a;
              return (
                (a = /^([^@+\/'"*`(;{}-]*);/.exec(C)), a ? ((y += a[0].length - 1), new x.Anonymous(a[1])) : void 0
              );
            },
            import: function () {
              var b,
              ...
              if (e) {
                ...
                if ((b = this.entities.quoted() || this.entities.url()))
                  return (
                    (c = this.mediaFeatures()),
                    i(';') || ((y = d), o('missing semi-colon or unrecognised media features on import')),
                    (c = c && new x.Value(c)),
                    new x.Import(b, c, f, d, a.currentFileInfo)
                  );
            ...
            media: function () {
              var b, c, d, e;
              return (
                a.dumpLineNumbers && (e = t(y, v, a)),
                j(/^@media/) && ((b = this.mediaFeatures()), (c = this.block()))
                  ? ((d = new x.Media(c, b, y, a.currentFileInfo)), a.dumpLineNumbers && (d.debugInfo = e), d)
                  : void 0
              );
            },
            directive: function () {
              ...
              if ('@' === v.charAt(y)) {
                ...
                if ((d(), (b = j(/^@[a-z-]+/)))) {
                  switch (
                    ((h = b),
                    '-' == b.charAt(1) && b.indexOf('-', 2) > 0 && (h = '@' + b.slice(b.indexOf('-', 2) + 1)),
                    h)
                  ) {
                    case '@charset':
                      (i = !0), (p = !1);
                  ...
                  return (
                    this.comments(),
                    i
                      ? ((c = this.entity()), c || o('expected ' + b + ' identifier'))
                      : l
                      ? ((c = this.expression()), c || o('expected ' + b + ' expression'))
                      : m && ((c = (j(/^[^{;]+/) || '').trim()), c && (c = new x.Anonymous(c))),
                    this.comments(),
                    p && (g = this.blockRuleset()),
                    g || (!p && c && k(';'))
                      ? (f(), new x.Directive(b, c, g, n, a.currentFileInfo, a.dumpLineNumbers ? t(n, v, a) : null))
                      : void e()
                  );
                }
              }
            ...
            value: function () {
              var a,
                b = [];
              do if (((a = this.expression()), a && (b.push(a), !k(',')))) break;
              while (a);
            ...
            sub: function () {
              var a, b;
              return k('(') && (a = this.addition())
                ? ((b = new x.Expression([a])), n(')'), (b.parens = !0), b)
                : void 0;
            },
            ...
            condition: function () {
              ...
              return (
                ...
                a
                  ? ((d = j(/^(?:>=|<=|=<|[<=>])/)),
                    d
                      ? ((b = this.addition() || e.keyword() || e.quoted()),
                        b ? (c = new x.Condition(d, a, b, f, g)) : o('expected expression'))
                      : (c = new x.Condition('=', a, new x.Keyword('true'), f, g)),
                    n(')'),
                    j(/^and/) ? new x.Condition('and', c, this.condition()) : c)
                  : void 0
              );
            },
            operand: function () {
                ...
                for (l(i), '' === g[0] && (g.shift(), h.shift()), e = 0; e < g.length; e++)
                  (d = g[e]),
                    (g[e] =
                      '@' !== d.charAt(0)
                        ? new x.Keyword(d)
                        : new x.Variable('@' + d.slice(2, -1), h[e], a.currentFileInfo));
                return g;
              }
            },
          }),
    ...
    (function (d) {
      ...
      (d.functions = {
        ...
        contrast: function (a, b, c, d) {
          ...
          return (d = 'undefined' == typeof d ? 0.43 : j(d)), a.luma() < d ? c : b;
        },
        e: function (a) {
        ...
        replace: function (a, b, c, e) {
          var f = a.value;
          return (
            (f = f.replace(new RegExp(b.value, e ? e.value : ''), c.value)), new d.Quoted(a.quote || '', f, a.escaped)
          );
        },
        '%': function (a) {
          ...
          if (!(a instanceof d.Dimension))
            throw {
              ...
              message:
                ...
                (a instanceof d.Operation ? '. Have you forgotten parenthesis?' : ''),
            };
        ...
        _minmax: function (a, c) {
          ...
          for (e = 0; e < c.length; e++)
            if (((g = c[e]), g instanceof d.Dimension))
              if (
                ((h = '' === g.unit.toString() && l !== b ? new d.Dimension(g.value, l).unify() : g.unify()),
                (j = '' === h.unit.toString() && k !== b ? k : h.unit.toString()),
                (k = ('' !== j && k === b) || ('' !== j && '' === m[0].unify().unit.toString()) ? j : k),
                (l = '' !== j && l === b ? g.unit.toString() : l),
                (f = n[''] !== b && '' !== j && j === k ? n[''] : n[j]),
                f !== b)
              )
                (i = '' === m[f].unit.toString() && l !== b ? new d.Dimension(m[f].value, l).unify() : m[f].unify()),
        ...
        'svg-gradient': function (a) {
          ...
          for (
            ...
            m[h].value ? ((i = m[h].value[0]), (j = m[h].value[1])) : ((i = m[h]), (j = b)),
              (i instanceof d.Color && (((0 === h || h + 1 === m.length) && j === b) || j instanceof d.Dimension)) ||
                e(),
              ...
              (g +=
                ...
                (1 > l ? ' stop-opacity="' + l + '"' : '') +
                '/>');
          if (((g += '</' + n + 'Gradient><rect ' + o + ' fill="url(#gradient)" /></svg>'), p))
            try {
      ...
      (a.debugInfo = function (b, c, d) {
        ...
        (a.debugInfo.asMediaQuery = function (a) {
          return (
            ...
            ('file://' + a.debugInfo.fileName).replace(/([.:\/\\])/g, function (a) {
              return '\\' == a && (a = '/'), '\\' + a;
            }) +
    ...
    (function (a) {
      ...
      (a.Color.prototype = {
        ...
        toCSS: function (b, e) {
          ...
          if (1 > g)
            return 0 === g && this.isTransparentKeyword
              ? d
              : 'rgba(' +
                  this.rgb
                    .map(function (a) {
    ...
    (function (a) {
      (a.Dimension = function (c, d) {
        ...
        (a.Dimension.prototype = {
          ...
          genCSS: function (b, c) {
            if (b && b.strictUnits && !this.unit.isSingular())
              throw new Error(
            ...
            if ('+' === c || '-' === c)
              ...
              '*' === c
                ? ((f.numerator = f.numerator.concat(d.unit.numerator).sort()),
                  (f.denominator = f.denominator.concat(d.unit.denominator).sort()),
                  f.cancel())
                : '/' === c &&
    ...
    (function (a) {
      (a.Extend = function (b, c, d) {
        switch (
          ...
          (this.option = c),
          (this.index = d),
          (this.object_id = a.Extend.next_id++),
        ...
        (a.JavaScript.prototype = {
          ...
          eval: function (b) {
            ...
            return 'number' == typeof c
              ...
              : new a.Anonymous(Array.isArray(c) ? c.join(', ') : c);
          },
        });
    })(c('../tree')),
    (function (a) {
      ...
      (a.Media = function (b, c, d, e) {
        ...
        (a.Media.prototype = {
          ...
          markReferenced: function () {
            ...
            for (this.rules[0].markReferenced(), this.isReferenced = !0, a = 0; a < b.length; a++)
          ...
          evalNested: function (b) {
            ...
            for (c = 0; c < e.length; c++)
              (d = e[c].features instanceof a.Value ? e[c].features.value : e[c].features),
    ...
    (function (a) {
      (a.mixin = {}),
            ...
            for (
              ...
              if ((c = b.frames[f].find(this.selector)).length > 0) {
                ...
                for (g = 0; g < r.length; g++)
                  if (((l = r[g].group), l === u || l === m))
                    try {
                      (d = r[g].mixin),
                        d instanceof a.mixin.Definition ||
                          ((o = d.originalRuleset || d),
                          (d = new a.mixin.Definition('', [], d.rules, null, !1)),
                          (d.originalRuleset = o)),
        ...
        (a.mixin.Definition.prototype = {
          ...
          eval: function (b) {
            return new a.mixin.Definition(
              this.name,
              this.params,
              this.rules,
              this.condition,
              this.variadic,
              this.frames || b.frames.slice(0)
            );
          },
          evalCall: function (b, c, d) {
            ...
            return (
              i.prependRule(new a.Rule('@arguments', new a.Expression(g).eval(b))),
          ...
          matchCondition: function (b, c) {
            return this.condition &&
              !this.condition.eval(
                new a.evalEnv(
                  c,
                  [this.evalParams(c, new a.evalEnv(c, this.frames ? this.frames.concat(c.frames) : c.frames), b, [])]
                    .concat(this.frames)
                    .concat(c.frames)
                )
              )
      ...
      (a.Operation = function (a, b, c) {
        ...
        (a.Operation.prototype = {
          ...
          eval: function (b) {
            ...
            if (b.isMathOn()) {
              if (
                (c instanceof a.Dimension && d instanceof a.Color && (c = c.toColor()),
                d instanceof a.Dimension && c instanceof a.Color && (d = d.toColor()),
                !c.operate)
              )
      ...
      (a.Quoted = function (a, b, c, d, e) {
        ...
        (a.Quoted.prototype = {
          ...
          compare: function (a) {
            ...
            var b, c;
            return (
              'Quoted' !== a.type || this.escaped || a.escaped
                ? ((b = this.toCSS()), (c = a.toCSS()))
                : ((b = a.value), (c = this.value)),
              b === c ? 0 : c > b ? -1 : 1
            );
          },
        });
    ...
    (function (a) {
      ...
      (a.Rule = function (c, d, e, f, g, h, i, j) {
        (this.name = c),
          (this.value = d instanceof a.Value || d instanceof a.Ruleset ? d : new a.Value([d])),
          (this.important = e ? ' ' + e.trim() : ''),
          (this.merge = f),
          (this.index = g),
          (this.currentFileInfo = h),
          (this.inline = i || !1),
          (this.variable = j !== b ? j : c.charAt && '@' === c.charAt(0));
      }),
        (a.Rule.prototype = {
          type: 'Rule',
          accept: function (a) {
          ...
          eval: function (b) {
            var d,
              ...
              g = this.variable;
            'string' != typeof f &&
              ((f = 1 === f.length && f[0] instanceof a.Keyword ? f[0].value : c(b, f)), (g = !1)),
              'font' !== f || b.strictMath || ((e = !0), (b.strictMath = !0));
            try {
              if (((d = this.value.eval(b)), !this.variable && 'DetachedRuleset' === d.type))
                throw {
              ...
              throw (
                ('number' != typeof h.index && ((h.index = this.index), (h.filename = this.currentFileInfo.filename)),
                h)
              );
            } finally {
              e && (b.strictMath = !1);
        ...
        (a.Ruleset.prototype = {
          ...
          eval: function (b) {
            ...
            if (g && (d = g.length)) {
              for (
                c = [],
                  h.error({type: 'Syntax', message: 'it is currently only allowed in parametric mixin guards,'}),
                  f = 0;
                d > f;
                f++
              )
            ...
            for (f = 0; q > f; f++)
              p[f] instanceof a.mixin.Call
                ? ((l = p[f].eval(b).filter(function (b) {
                    return b instanceof a.Rule && b.variable ? !m.variable(b.name) : !0;
                  })),
                  p.splice.apply(p, [f, 1].concat(l)),
                  (q += l.length - 1),
                  (f += l.length - 1),
                  m.resetCache())
                : p[f] instanceof a.RulesetCall &&
                  ((l = p[f].eval(b).rules.filter(function (b) {
            ...
            for (f = 0; f < p.length; f++)
              (j = p[f]),
                j instanceof a.mixin.Definition ||
                  j instanceof a.DetachedRuleset ||
                  (p[f] = j = j.eval ? j.eval(b) : j);
            for (f = 0; f < p.length; f++)
              if (
                ((j = p[f]),
                j instanceof a.Ruleset &&
                  j.selectors &&
                  1 === j.selectors.length &&
                  j.selectors[0].isJustParentSelector())
              ) {
                p.splice(f--, 1);
                for (var s = 0; s < j.rules.length; s++)
          ...
          evalImports: function (b) {
            ...
            if (e)
              for (c = 0; c < e.length; c++)
                e[c] instanceof a.Import &&
                  ((d = e[c].eval(b)),
                  d && d.length ? (e.splice.apply(e, [c, 1].concat(d)), (c += d.length - 1)) : e.splice(c, 1, d),
                  this.resetCache());
          },
          makeImportant: function () {
            ...
            return (
              this._variables ||
                (this._variables = this.rules
                  ? this.rules.reduce(function (b, c) {
                  ...
                  if (f !== c)
                    for (var g = 0; g < f.selectors.length; g++)
                      if ((d = b.match(f.selectors[g]))) {
                        b.elements.length > d
                          ? Array.prototype.push.apply(e, f.find(new a.Selector(b.elements.slice(d)), c))
                          : e.push(f);
                        break;
                      }
                }),
          ...
          genCSS: function (b, c) {
            function d(b, c) {
              return b.rules
                ? !0
                : b instanceof a.Media || (c && b instanceof a.Comment)
                ? !0
                : b instanceof a.Directive || b instanceof a.Anonymous
                ? b.isRulesetLike()
                : !1;
            }
            var e,
            ...
            if (((l = k.concat(l)), !this.root)) {
              ...
              for (n = b.compress ? ',' : ',\n' + p, e = 0; s > e; e++)
                if (((j = r[e]), (q = j.length)))
                  for (
                    e > 0 && c.add(n), b.firstSelector = !0, j[0].genCSS(b, c), b.firstSelector = !1, f = 1;
                    q > f;
                    f++
                  )
                    j[f].genCSS(b, c);
            ...
            for (e = 0; e < l.length; e++)
              (i = l[e]),
                e + 1 !== l.length || (this.root && 0 !== m.length && !this.firstRoot) || (b.lastRule = !0),
                i.genCSS ? i.genCSS(b, c) : i.value && c.add(i.value.toString()),
                b.lastRule ? (b.lastRule = !1) : c.add(b.compress ? '' : '\n' + o);
            if (
              (this.root || (c.add(b.compress ? '}' : '\n' + p + '}'), b.tabLevel--),
              (n = (b.compress ? '' : '\n') + (this.root ? o : p)),
              (g = m.length))
            )
                  ...
                  for (s = [], r.length > 0 && this.mergeElementsOnToSelectors(r, i), f = 0; f < i.length; f++)
                    if (((k = i[f]), 0 === c.length))
                      k.length > 0 &&
                        ...
                        k[0].elements.push(new a.Element(j.combinator, '', j.index, j.currentFileInfo))),
                        s.push(k);
                    else
                      for (g = 0; g < c.length; g++)
                        (l = c[g]),
                          ...
                          (p = !0),
                          k.length > 0
                            ? ((m = k.slice(0)), (q = m.pop()), (o = d.createDerived(q.elements.slice(0))), (p = !1))
                            : (o = d.createDerived([])),
                          l.length > 1 && (n = n.concat(l.slice(1))),
                          l.length > 0 &&
                            ((p = !1),
                            o.elements.push(
                              new a.Element(j.combinator, l[0].elements[0].value, j.index, j.currentFileInfo)
                            ),
                            (o.elements = o.elements.concat(l[0].elements.slice(1)))),
                          p || m.push(o),
                          (m = m.concat(n)),
                          s.push(m);
                  (i = s), (r = []);
        ...
        (a.URL.prototype = {
          ...
          eval: function (b) {
            ...
            if (
              ...
              b.urlArgs && !d.value.match(/^\s*data:/))
            ) {
      ...
      (a.Variable = function (a, b, c) {
        ...
        (a.Variable.prototype = {
          ...
          eval: function (b) {
            var c,
              d = this.name;
            if ((0 === d.indexOf('@@') && (d = '@' + new a.Variable(d.slice(1)).eval(b).value), this.evaluating))
              throw {
                type: 'Name',
    ...
    (function (a) {
      ...
      a.parseEnv = function (a) {
        if (
          ...
          this.contentsIgnoredChars || (this.contentsIgnoredChars = {}),
      ...
      (a.visitor = function (b) {
        ...
        (a.visitor.prototype = {
          visit: function (a) {
            ...
            if (
              ((l.visitDeeper = !0),
              j || ((e = 'visit' + a.type), (j = g[e] || b), (k = g[e + 'Out'] || b), (f[h] = j), (f[i] = k)),
              j !== b)
            ) {
              var m = j.call(g, a, l);
              g.isReplacing && (a = m);
            ...
            if (!b.css || f) {
              ...
              if (d && (!d.css || f)) {
                ...
                b.options.multiple && (h.importMultiple = !0),
                  this._importer.push(b.getPath(), b.currentFileInfo, b.options, function (c, d, g, i) {
                    ...
                    return !d || ((b.root = d), (b.importedFilename = i), f || (!h.importMultiple && j))
                      ? void k()
                      : ((e.recursionDetector[i] = !0),
                        void new a.importVisitor(e._importer, k, h, e.onceFileDetectionMap, e.recursionDetector).run(
                          d
                        ));
                  });
              }
            ...
            if ((b.firstRoot && this.checkPropertiesInRoot(b.rules), b.root))
              ...
              b.paths &&
                (b.paths = b.paths.filter(function (b) {
                  var c;
                  for (
                    ' ' === b[0].elements[0].combinator.value && (b[0].elements[0].combinator = new a.Combinator('')),
                      c = 0;
                    c < b.length;
                    c++
                  )
            ...
            if (((b = b.value), (c = c.value), b instanceof a.Selector)) {
              ...
              for (var d = 0; d < b.elements.length; d++) {
                if (
                  ...
                  (0 !== d || (b.elements[d].combinator.value || ' ') !== (c.elements[d].combinator.value || ' '))
                )
                  return !1;
          ...
          extendSelector: function (b, c, d) {
            ...
            for (e = 0; e < b.length; e++)
              (h = b[e]),
                ...
                h.pathIndex > j &&
                  k > 0 &&
                  ((l[l.length - 1].elements = l[l.length - 1].elements.concat(c[j].elements.slice(k))), (k = 0), j++),
                (i = f.elements.slice(k, h.index).concat([g]).concat(d.elements.slice(1))),
                j === h.pathIndex && e > 0
                  ? (l[l.length - 1].elements = l[l.length - 1].elements.concat(i))
                  : ((l = l.concat(c.slice(j, h.pathIndex))), l.push(new a.Selector(i))),
                (j = h.endPathIndex),
            ...
            return (
              j < c.length &&
                k > 0 &&
                ((l[l.length - 1].elements = l[l.length - 1].elements.concat(c[j].elements.slice(k))), j++),
      ...
      (a.sourceMapOutput = function (a) {
        ...
        (a.sourceMapOutput.prototype.toCSS = function (a) {
          ...
          if ((this._rootNode.genCSS(a, this), this._css.length > 0)) {
            var e,
              f = JSON.stringify(this._sourceMapGenerator.toJSON());
            this._sourceMapURL
              ? (e = this._sourceMapURL)
              : this._sourceMapFilename && (e = this.normalizeFilename(this._sourceMapFilename)),
              this._writeSourceMap
                ? this._writeSourceMap(f)
                : (e = 'data:application/json;base64,' + c('./encoder.js').encodeBase64(f)),
  ...
  if (
    ((w.logLevel = 'undefined' != typeof w.logLevel ? w.logLevel : 'development' === w.env ? z.debug : z.errors),
    (w.async = w.async || !1),
