...
!(function (a) {
      ...
      if (
        (b.trustedOrigins &&
          ('string' == typeof b.trustedOrigins
            ...
            : 'object' == typeof b.trustedOrigins && 'length' in b.trustedOrigins && (g = g.concat(b.trustedOrigins))),
        b.trustedDomains &&
          ('string' == typeof b.trustedDomains
            ? g.push(b.trustedDomains)
            : 'object' == typeof b.trustedDomains && 'length' in b.trustedDomains && (g = g.concat(b.trustedDomains))),
        g.length)
      )
    ...
    K = function (a, b) {
      return this instanceof K
        ? ((this.id = '' + g++),
          ...
          e.disabled === !1 && e.outdated !== !0 && null === e.bridge && ((e.outdated = !1), (e.ready = !1), O()),
          void 0)
        : new K(a, b);
    };
  ...
  var T = function (a, g) {
    ...
    switch (a) {
      case 'load':
        if (h) {
          if (!c(h)) return T.call(this, 'onWrongFlash', {flashVersion: h}), void 0;
