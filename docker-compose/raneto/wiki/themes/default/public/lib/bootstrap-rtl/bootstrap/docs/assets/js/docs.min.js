...
!(function (a, b, c) {
    ...
    (document.querySelectorAll = function (a) {
      ...
      for (
        document.documentElement.firstChild.appendChild(c),
          document._qsa = [],
          c.styleSheet.cssText = a + '{x-qsa:expression(document._qsa && document._qsa.push(this))}',
          window.scrollBy(0, 0),
      ...
      function (a) {
        ...
        return (
          12 === g
            ...
            : 18 === g &&
              ((f >>= 2), e.push(String.fromCharCode((f >> 8) & 255)), e.push(String.fromCharCode(255 & f))),
          e.join('')
        );
      }),
      (a.btoa =
  ...
  (function () {
    function a(b, c, d) {
      ...
      var e,
        ...
        h = f[2];
      return (
        (d = d ? (/%|em/.test(h) && b.parentElement ? a(b.parentElement, 'fontSize', null) : 16) : d),
  ...
  (function (a, b) {
    ...
    function d(a, b) {
      for (
        var c = {theme: p(A.settings.themes.gray, null), stylesheets: b.stylesheets, holderURL: []},
          d = !1,
          e = String.fromCharCode(11),
          f = a.replace(/([^\\])\//g, '$1' + e).split(e),
          g = /%[0-9a-f]{2}/gi,
          h = f.length,
          i = 0;
        h > i;
    ...
    function e(a, b, c, d) {
      ...
      if (
        ((a = null == a ? (c.fluid ? 'fluid' : 'image') : a),
        null != c.text && ((g.text = c.text), 'object' === b.nodeName.toLowerCase()))
      ) {
      ...
      c.font &&
        ...
        !o.noFontFallback &&
          ...
          'svg' === o.renderer &&
          (o = p(o, {renderer: 'canvas'}))),
        c.font && 'canvas' == o.renderer && (o.reRender = !0),
        'background' == a
          ? null == b.getAttribute('data-background-src') && m(b, {'data-background-src': n})
          : m(b, {'data-src': n}),
        (c.theme = g),
        (b.holderData = {flags: c, renderSettings: o}),
        ('image' == a || 'fluid' == a) &&
          m(b, {alt: g.text ? (g.text.length > 16 ? g.text.substring(0, 16) + '…' : g.text) + ' [' + h + ']' : h}),
        'image' == a
          ? (('html' != o.renderer && c.auto) || ((b.style.width = e.width + 'px'), (b.style.height = e.height + 'px')),
            'html' == o.renderer
              ? (b.style.backgroundColor = g.background)
              : (f(a, {dimensions: e, theme: g, flags: c}, b, o),
                c.textmode && 'exact' == c.textmode && (A.vars.resizableImages.push(b), i(b))))
          : 'background' == a && 'html' != o.renderer
          ? f(a, {dimensions: e, theme: g, flags: c}, b, o)
          : 'fluid' == a &&
            ('%' == e.height.slice(-1)
              ? (b.style.height = e.height)
              : (null != c.auto && c.auto) || (b.style.height = e.height + 'px'),
            '%' == e.width.slice(-1)
              ? (b.style.width = e.width)
              : (null != c.auto && c.auto) || (b.style.width = e.width + 'px'),
            ('inline' == b.style.display || '' === b.style.display || 'none' == b.style.display) &&
              (b.style.display = 'block'),
            k(b),
            'html' == o.renderer ? (b.style.backgroundColor = g.background) : (A.vars.resizableImages.push(b), i(b)));
    }
    function f(a, b, c, d) {
      function e() {
        var a = null;
      ...
      'background' == a
        ? ((c.style.backgroundImage = 'url(' + f + ')'), (c.style.backgroundSize = h.width + 'px ' + h.height + 'px'))
        : ('img' === c.nodeName.toLowerCase()
            ? m(c, {src: f})
            : 'object' === c.nodeName.toLowerCase() && (m(c, {data: f}), m(c, {type: 'image/svg+xml'})),
          d.reRender &&
            setTimeout(function () {
              var a = e();
              ...
              'img' === c.nodeName.toLowerCase()
                ? m(c, {src: a})
                : 'object' === c.nodeName.toLowerCase() && (m(c, {data: a}), m(c, {type: 'image/svg+xml'}));
            }, 100)),
        m(c, {'data-holder-rendered': !0});
    }
    function g(a) {
      function b(a, b, c, d) {
      ...
      switch (
        ...
        (a.text = a.theme.text ? a.theme.text : Math.floor(a.width) + 'x' + Math.floor(a.height)),
        a.flags.textmode)
      ) {
        case 'literal':
    ...
    function j(a, b) {
      ...
      return c.height || c.width
        ? (a.removeAttribute('data-holder-invisible'), c)
        : (m(a, {'data-holder-invisible': !0}), void b.call(this, a));
    }
    function k(a) {
      if (a.holderData) {
        ...
        if (b) {
          ...
          d.fluidWidth && !d.fluidHeight
            ? ((d.mode = 'width'), (d.ratio = d.initialDimensions.width / parseFloat(c.dimensions.height)))
            : !d.fluidWidth &&
              d.fluidHeight &&
              ((d.mode = 'height'), (d.ratio = parseFloat(c.dimensions.width) / d.initialDimensions.height)),
    ...
    function n(a, b, c) {
      ...
      return (
        a.webkitMatchesSelector && a.setAttribute('xmlns', x),
        m(a, {width: b, height: c, viewBox: '0 0 ' + b + ' ' + c, preserveAspectRatio: 'none'}),
        a
      );
    }
    function o(a, c) {
    ...
    function t(a) {
      ...
      return (
        'string' == typeof a
          ? (c = y.querySelectorAll(a))
          : b.NodeList && a instanceof b.NodeList
          ? (c = a)
          : b.Node && a instanceof b.Node
          ? (c = [a])
          : b.HTMLCollection && a instanceof b.HTMLCollection
          ? (c = a)
          : null === a && (c = []),
        c
      );
      ...
      z = {
        ...
        run: function (a) {
          ...
          (f.renderer = g.renderer ? g.renderer : A.setup.renderer),
            -1 === A.setup.renderers.join(',').indexOf(f.renderer) &&
              (f.renderer = A.setup.supportsSVG ? 'svg' : A.setup.supportsCanvas ? 'canvas' : 'html'),
    ...
    var A = {
      ...
      C = (function () {
        ...
        return function (c) {
          ...
          e.properties,
            (b.font =
              e.properties.font.weight +
              ' ' +
              A.dpr(e.properties.font.size) +
              e.properties.font.units +
              ' ' +
              e.properties.font.family +
              ', monospace'),
      ...
      E = function (a) {
        ...
        var c = 1,
          ...
          f = augment(d, function (a) {
            ...
            (this.Group = augment.extend(this, {constructor: c, type: 'group'})),
              (this.Rect = augment.extend(this, {constructor: c, type: 'rect'})),
    ...
    (A.setup = {
      ...
      (function () {
        var a = 1,
          ...
          e = null;
        d.getContext &&
          -1 != d.toDataURL('image/png').indexOf('data:image/png') &&
          ((A.setup.renderer = 'canvas'), (e = d.getContext('2d')), (A.setup.supportsCanvas = !0)),
          A.setup.supportsCanvas &&
            ((a = b.devicePixelRatio || 1),
            (c =
          ...
          (A.setup.ratio = a / c),
          y.createElementNS &&
            y.createElementNS(x, 'svg').createSVGRect &&
      ...
      b.onDomReady &&
        b.onDomReady(function () {
          A.vars.preempted || z.run(),
            b.addEventListener
              ? (b.addEventListener('resize', s, !1), b.addEventListener('orientationchange', s, !1))
   ...
   */ !(function (a) {
    ...
    var d,
      ...
      o = function (b, c) {
        ...
        return (
          a.getComputedStyle
            ...
            : ((e = n(c)), (d = b.currentStyle ? b.currentStyle[e] : b.style[e])),
      ...
      x = function (b) {
        ...
        if (
          (b.trustedOrigins &&
            ('string' == typeof b.trustedOrigins
              ? g.push(b.trustedOrigins)
              : 'object' == typeof b.trustedOrigins &&
                'length' in b.trustedOrigins &&
                (g = g.concat(b.trustedOrigins))),
          b.trustedDomains &&
            ('string' == typeof b.trustedDomains
              ? g.push(b.trustedDomains)
              : 'object' == typeof b.trustedDomains &&
                'length' in b.trustedDomains &&
                (g = g.concat(b.trustedDomains))),
          g.length)
        )
        ...
        return (
          h.length && f.push('trustedOrigins=' + encodeURIComponent(h.join(','))),
      ...
      B = function (a) {
        ...
        return (
          a &&
            ('number' == typeof a && a > 0
              ? (b = a)
              : 'string' == typeof a && (c = parseInt(a, 10)) && !isNaN(c) && c > 0 && (b = c)),
          b ||
            ('number' == typeof N.zIndex && N.zIndex > 0
              ? (b = N.zIndex)
              : 'string' == typeof N.zIndex && (c = parseInt(N.zIndex, 10)) && !isNaN(c) && c > 0 && (b = c)),
          b || 0
        );
      },
      C = function (a, b) {
      ...
      K = function (a, b) {
        return this instanceof K
          ? ((this.id = '' + g++),
            (h[this.id] = {instance: this, elements: [], handlers: {}}),
            a && this.clip(a),
            'undefined' != typeof b && (C('new ZeroClipboard(elements, options)', N.debug), K.config(b)),
            (this.options = K.config()),
            'boolean' != typeof e.disabled && (e.disabled = !J()),
            void (
              e.disabled === !1 &&
              e.outdated !== !0 &&
              null === e.bridge &&
              ((e.outdated = !1), (e.ready = !1), O())
            ))
          : new K(a, b);
      };
    (K.prototype.setText = function (a) {
      return (
        a &&
          '' !== a &&
          ((f['text/plain'] = a),
          e.ready === !0 && e.bridge && 'function' == typeof e.bridge.setText ? e.bridge.setText(a) : (e.ready = !1)),
        this
      );
    }),
      (K.prototype.setSize = function (a, b) {
        return (
          e.ready === !0 && e.bridge && 'function' == typeof e.bridge.setSize ? e.bridge.setSize(a, b) : (e.ready = !1),
          this
        );
      });
    var L = function (a) {
      e.ready === !0 && e.bridge && 'function' == typeof e.bridge.setHandCursor
        ? e.bridge.setHandCursor(a)
        : (e.ready = !1);
    };
    ...
    (K.config = function (a) {
      if (('object' == typeof a && null !== a && D(N, a), 'string' != typeof a || !a)) {
        ...
        for (var c in N)
          N.hasOwnProperty(c) &&
            (b[c] = 'object' == typeof N[c] && null !== N[c] ? ('length' in N[c] ? N[c].slice(0) : D({}, N[c])) : N[c]);
        return b;
      }
      ...
      Q = function () {
        if (d) {
          ...
          b &&
            ...
            (b.style.zIndex = a.zIndex + 1)),
            e.ready === !0 && e.bridge && 'function' == typeof e.bridge.setSize
              ? e.bridge.setSize(a.width, a.height)
              : (e.ready = !1);
        }
        return this;
      };
    (K.prototype.on = function (a, b) {
      ...
      if (f && f.length) {
        ...
        g.noflash && e.disabled && T.call(this, 'noflash', {}),
          g.wrongflash && e.outdated && T.call(this, 'wrongflash', {flashVersion: e.version}),
          g.load && e.ready && T.call(this, 'load', {flashVersion: e.version});
      }
      return this;
    }),
        ...
        if (f && f.length)
          for (c = 0, d = f.length; d > c; c++)
            if (((a = f[c].toLowerCase().replace(/^on/, '')), (g = i[a]), g && g.length))
              if (b) for (e = y(b, g); -1 !== e; ) g.splice(e, 1), (e = y(b, g, e));
              else i[a].length = 0;
        return this;
      }),
    ...
    (K.prototype.clip = function (a) {
      ...
      for (var b = 0; b < a.length; b++)
        if (a.hasOwnProperty(b) && a[b] && 1 === a[b].nodeType) {
          a[b].zcClippingId
            ? -1 === y(this.id, j[a[b].zcClippingId]) && j[a[b].zcClippingId].push(this.id)
            : ((a[b].zcClippingId = 'zcClippingId_' + i++),
              (j[a[b].zcClippingId] = [this.id]),
              N.autoActivate === !0 && q(a[b], 'mouseover', p));
    ...
    (N.hoverClass = 'zeroclipboard-is-hover'),
      ...
      (K.prototype.setHandCursor = function (a) {
        return (
          C('ZeroClipboard.prototype.setHandCursor', N.debug),
    ...
    'function' == typeof define && define.amd
      ? define(['require', 'exports', 'module'], function (a, b, c) {
      ...
      : 'object' == typeof module &&
        ...
        module.exports &&
        'function' == typeof a.require
      ? ((l = module.id || null), (module.exports = K))
      : (a.ZeroClipboard = K);
  })(
    (function () {
      return this;
   ...
   */ !(function (a) {
    ...
    a(function () {
      ...
      c.scrollspy({target: '.bs-docs-sidebar'}),
        ...
        (function () {
          ...
          localStorage.getItem('previewTheme') && d(),
            c.click(function () {
              var a = b.attr('href');
              a && 0 !== a.indexOf('data')
                ? (b.attr('href', ''), c.text('Preview theme'), localStorage.removeItem('previewTheme'))
                : d();
            });
        })(),
        ...
        ZeroClipboard.config({moviePath: '/assets/flash/ZeroClipboard.swf', hoverClass: 'btn-clipboard-hover'}),
