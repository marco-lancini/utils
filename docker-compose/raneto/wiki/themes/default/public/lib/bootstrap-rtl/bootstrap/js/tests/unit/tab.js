$(function () {
  ...
  test('should activate element by tab id', function () {
    var tabsHTML =
      '<ul class="tabs">' + '<li><a href="#home">Home</a></li>' + '<li><a href="#profile">Profile</a></li>' + '</ul>';
  ...
  test('should activate element by tab id', function () {
    var pillsHTML =
      '<ul class="pills">' + '<li><a href="#home">Home</a></li>' + '<li><a href="#profile">Profile</a></li>' + '</ul>';
  ...
  test('selected tab should have aria-expanded', function () {
    ...
    equal(
      $tabs.find('li:not(.active) a').attr('aria-expanded'),
      'false',
    ...
    equal(
      $tabs.find('.active a').attr('aria-expanded'),
      'true',
