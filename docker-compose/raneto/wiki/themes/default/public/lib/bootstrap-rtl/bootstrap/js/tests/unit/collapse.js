$(function () {
  ...
  test('should remove "collapsed" class from active accordion target', function (assert) {
    ...
    var $target2 = $('<a class="collapsed" data-toggle="collapse" href="#body2" data-parent="#accordion"/>').appendTo(
      $groups.eq(1)
    );

    $('<div id="body2"/>').appendTo($groups.eq(1));

    var $target3 = $('<a class="collapsed" data-toggle="collapse" href="#body3" data-parent="#accordion"/>').appendTo(
      $groups.eq(2)
    );
  ...
  test('should set aria-expanded="true" on target when collapse is shown', function (assert) {
    ...
    var $target = $('<a data-toggle="collapse" class="collapsed" href="#test1" aria-expanded="false"/>').appendTo(
      '#qunit-fixture'
    );
