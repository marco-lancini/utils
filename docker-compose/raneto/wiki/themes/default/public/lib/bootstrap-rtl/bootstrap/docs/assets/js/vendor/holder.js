...
!(function (e, t, r) {
  ...
  document.querySelectorAll ||
    (document.querySelectorAll = function (e) {
      var t,
        ...
        n = [];
      for (
        document.documentElement.firstChild.appendChild(r),
          document._qsa = [],
          r.styleSheet.cssText = e + '{x-qsa:expression(document._qsa && document._qsa.push(this))}',
          window.scrollBy(0, 0),
  ...
  (function () {
    function e(t, r, n) {
      t.document;
      var i,
        o = t.currentStyle[r].match(/([\d\.]+)(%|cm|em|in|mm|pc|pt|)/) || [0, 0, ''],
        a = o[1],
        l = o[2];
      return (
        (n = n ? (/%|em/.test(l) && t.parentElement ? e(t.parentElement, 'fontSize', null) : 16) : n),
  ...
  (function (e, t) {
    ...
    function n(e, t) {
      for (
        var r = {theme: p(A.settings.themes.gray, null), stylesheets: t.stylesheets, holderURL: []},
          n = !1,
    ...
    function i(e, t, r, n) {
      ...
      if (
        ((e = null == e ? (r.fluid ? 'fluid' : 'image') : e),
      ...
      r.font &&
        ...
        !g.noFontFallback &&
          ...
          'svg' === g.renderer &&
          (g = p(g, {renderer: 'canvas'}))),
        r.font && 'canvas' == g.renderer && (g.reRender = !0),
        'background' == e
          ? null == t.getAttribute('data-background-src') && c(t, {'data-background-src': f})
          : c(t, {'data-src': f}),
        (r.theme = a),
        (t.holderData = {flags: r, renderSettings: g}),
        ('image' == e || 'fluid' == e) &&
          c(t, {alt: a.text ? (a.text.length > 16 ? a.text.substring(0, 16) + '…' : a.text) + ' [' + l + ']' : l}),
        'image' == e
          ...
          : 'fluid' == e &&
            ...
            h(t),
            'html' == g.renderer ? (t.style.backgroundColor = a.background) : (A.vars.resizableImages.push(t), s(t)));
    }
    function o(e, t, r, n) {
      function i() {
        var e = null;
      ...
      {
        var l = {width: t.dimensions.width, height: t.dimensions.height, theme: t.theme, flags: t.flags},
          s = a(l);
        ({
          text: l.text,
          width: l.width,
        ...
        : ('img' === r.nodeName.toLowerCase()
          ...
          n.reRender &&
            setTimeout(function () {
              ...
              'img' === r.nodeName.toLowerCase()
                ? c(r, {src: e})
                : 'object' === r.nodeName.toLowerCase() && (c(r, {data: e}), c(r, {type: 'image/svg+xml'}));
            }, 100)),
        c(r, {'data-holder-rendered': !0});
    }
    function a(e) {
      function t(e, t, r, n) {
      ...
      switch (
        ...
        (e.text = e.theme.text ? e.theme.text : Math.floor(e.width) + 'x' + Math.floor(e.height)),
        e.flags.textmode)
      ) {
        case 'literal':
      ...
      if (e.holderData) {
        ...
        if (t) {
          ...
          n.fluidWidth && !n.fluidHeight
            ...
            : !n.fluidWidth &&
              n.fluidHeight &&
              ((n.mode = 'height'), (n.ratio = parseFloat(r.dimensions.width) / n.initialDimensions.height)),
    ...
    function f(e, t, r) {
      ...
      return (
        e.webkitMatchesSelector && e.setAttribute('xmlns', C),
        c(e, {width: t, height: r, viewBox: '0 0 ' + t + ' ' + r, preserveAspectRatio: 'none'}),
        e
      );
    }
    function g(e, r) {
      ...
      k = {
        ...
        run: function (e) {
          ...
          (o.renderer = a.renderer ? a.renderer : A.setup.renderer),
            -1 === A.setup.renderers.join(',').indexOf(o.renderer) &&
              (o.renderer = A.setup.supportsSVG ? 'svg' : A.setup.supportsCanvas ? 'canvas' : 'html'),
      ...
      z = function (e) {
        ...
        var r = 1,
          ...
          o = augment(n, function (e) {
            function r(r, n) {
              if ((e.constructor.call(this, r), (this.properties = {fill: '#000'}), null != n)) t(this.properties, n);
              else if (null != r && 'string' != typeof r) throw 'SceneGraph: invalid node name';
            }
            (this.Group = augment.extend(this, {constructor: r, type: 'group'})),
              (this.Rect = augment.extend(this, {constructor: r, type: 'rect'})),
    ...
    for (var F in A.flags)
      A.flags.hasOwnProperty(F) &&
        (A.flags[F].match = function (e) {
    ...
    (A.setup = {
      ...
      (A.vars = {preempted: !1, resizableImages: [], debounceTimer: null, cache: {}}),
      (function () {
        var e = 1,
          r = 1,
          n = u('canvas'),
        ...
        n.getContext &&
          ...
          ((A.setup.renderer = 'canvas'), (i = n.getContext('2d')), (A.setup.supportsCanvas = !0)),
          A.setup.supportsCanvas &&
