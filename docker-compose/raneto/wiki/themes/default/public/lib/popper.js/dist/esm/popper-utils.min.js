...
function c(d) {
  ...
  var e = a(d),
    ...
    g = e.overflowX,
    h = e.overflowY;
  return /(auto|scroll|overlay)/.test(f + h + g) ? d : c(b(d));
}
...
function h(b) {
  ...
  for (var c = g(10) ? document.body : null, d = b.offsetParent || null; d === c && b.nextElementSibling; )
    d = (b = b.nextElementSibling).offsetParent;
  var e = d && d.nodeName;
  return e && 'BODY' !== e && 'HTML' !== e
    ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(d.nodeName) && 'static' === a(d, 'position')
      ? h(d)
      : d
    : b
...
function l(a, b) {
  ...
  if ((a !== g && b !== g) || d.contains(e)) return j(g) ? g : h(g);
  var i = k(a);
  return i.host ? l(i.host, b) : l(a, k(b).host);
}
function m(a) {
...
function q(a) {
  ...
  return {height: p('Height', b, c, d), width: p('Width', b, c, d)};
}
var r =
  Object.assign ||
  function (a) {
...
function t(b) {
  ...
  var f = {left: c.left, top: c.top, width: c.right - c.left, height: c.bottom - c.top},
    h = 'HTML' === b.nodeName ? q(b.ownerDocument) : {},
  ...
  if (k || l) {
    var n = a(b);
    (k -= o(n, 'x')), (l -= o(n, 'y')), (f.width -= k), (f.height -= l);
  }
  return s(f);
}
function u(b, d) {
  var e = Math.max,
    ...
    p = parseFloat(m.borderLeftWidth, 10);
  f && i && ((k.top = e(k.top, 0)), (k.left = e(k.left, 0)));
  var q = s({top: j.top - k.top - o, left: j.left - k.left - p, width: j.width, height: j.height});
  if (((q.marginTop = 0), (q.marginLeft = 0), !h && i)) {
    var r = parseFloat(m.marginTop, 10),
      u = parseFloat(m.marginLeft, 10);
    (q.top -= o - r), (q.bottom -= o - r), (q.left -= p - u), (q.right -= p - u), (q.marginTop = r), (q.marginLeft = u);
  }
...
function v(a) {
  var b = Math.max,
    ...
    h = c ? 0 : m(d),
    i = c ? 0 : m(d, 'left'),
    j = {top: h - e.top + e.marginTop, left: i - e.left + e.marginLeft, width: f, height: g};
  return s(j);
}
function w(c) {
  var d = c.nodeName;
...
function x(b) {
  ...
  for (var c = b.parentElement; c && 'none' === a(c, 'transform'); ) c = c.parentElement;
...
function y(a, d, e, f) {
  var g = 4 < arguments.length && void 0 !== arguments[4] && arguments[4],
    h = {top: 0, left: 0},
    i = g ? x(a) : l(a, d);
  if ('viewport' === f) h = v(i, g);
  else {
    var j;
    'scrollParent' === f
      ? ((j = c(b(d))), 'BODY' === j.nodeName && (j = a.ownerDocument.documentElement))
      : 'window' === f
      ? (j = a.ownerDocument.documentElement)
      : (j = f);
    var k = u(j, i, g);
    if ('HTML' === j.nodeName && !w(i)) {
      var m = q(a.ownerDocument),
        n = m.height,
        o = m.width;
      (h.top += k.top - k.marginTop), (h.bottom = n + k.top), (h.left += k.left - k.marginLeft), (h.right = o + k.left);
    } else h = k;
  }
  e = e || 0;
  var p = 'number' == typeof e;
  return (
    (h.left += p ? e : e.left || 0),
    (h.top += p ? e : e.top || 0),
    (h.right -= p ? e : e.right || 0),
    (h.bottom -= p ? e : e.bottom || 0),
    h
  );
}
function z(a) {
...
function A(a, b, c, d, e) {
  var f = 5 < arguments.length && arguments[5] !== void 0 ? arguments[5] : 0;
...
function J(a) {
  var b;
  if ('HTML' === a.nodeName) {
    var c = q(a.ownerDocument),
      d = c.width,
      e = c.height;
    b = {width: d, height: e, left: 0, top: 0};
  } else b = {width: a.offsetWidth, height: a.offsetHeight, left: a.offsetLeft, top: a.offsetTop};
  return s(b);
}
function K(a) {
...
function M(a, b, c) {
  ...
  var d = K(a),
    ...
    i = f ? 'height' : 'width',
    j = f ? 'width' : 'height';
  return (e[g] = b[g] + b[i] / 2 - d[i] / 2), (e[h] = c === h ? b[h] - d[j] : b[L(h)]), e;
}
function N(a, b, c) {
...
function U(a, b) {
  return (
    T(a).removeEventListener('resize', b.updateBound),
...
function V(a, b, c) {
  var d = void 0 === c ? a : a.slice(0, I(a, 'name', c));
  return (
    d.forEach(function (a) {
      ...
      a.enabled &&
        P(c) &&
        ((b.offsets.popper = s(b.offsets.popper)), (b.offsets.reference = s(b.offsets.reference)), (b = c(b, a)));
    }),
    b
  );
}
...
function Y(a, b, d, e) {
  ...
  g.addEventListener(b, d, {passive: !0}), f || Y(c(g.parentNode), b, d, e), e.push(g);
}
function Z(a, b, d, e) {
  (d.updateBound = e), T(a).addEventListener('resize', d.updateBound, {passive: !0});
  var f = c(a);
  return Y(f, 'scroll', d.updateBound, d.scrollParents), (d.scrollElement = f), (d.eventsEnabled = !0), d;
}
var $ = {
  ...
  getParentNode: b,
  getPopperOffsets: M,
  getReferenceOffsets: N,
  getScroll: m,
  getScrollParent: c,
  getStyleComputedProperty: a,
  getSupportedPropertyName: O,
  getWindowSizes: q,
  isFixed: w,
  isFunction: P,
  isModifierEnabled: Q,
  isModifierRequired: R,
  isNumeric: S,
  removeEventListeners: U,
  runModifiers: V,
  setAttributes: W,
  setStyles: X,
  setupEventListeners: Z,
};
export {
  A as computeAutoPlacement,
  G as debounce,
  I as findIndex,
  o as getBordersSize,
  y as getBoundaries,
  ...
  J as getOffsetRect,
  u as getOffsetRectRelativeToArbitraryNode,
  K as getOuterSizes,
  b as getParentNode,
  M as getPopperOffsets,
  N as getReferenceOffsets,
  m as getScroll,
  c as getScrollParent,
  a as getStyleComputedProperty,
  O as getSupportedPropertyName,
  q as getWindowSizes,
  w as isFixed,
  P as isFunction,
  Q as isModifierEnabled,
  R as isModifierRequired,
  S as isNumeric,
  U as removeEventListeners,
  V as runModifiers,
  W as setAttributes,
  X as setStyles,
  Z as setupEventListeners,
};
export default $;
