 ...
 */ (function (
  ...
  function f(a) {
    ...
    for (var c = e(10) ? document.body : null, d = a.offsetParent || null; d === c && a.nextElementSibling; )
      d = (a = a.nextElementSibling).offsetParent;
    var g = d && d.nodeName;
    return g && 'BODY' !== g && 'HTML' !== g
      ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(d.nodeName) && 'static' === b(d, 'position')
        ? f(d)
        : d
      : a
  ...
  function j(a, b) {
    ...
    i.setStart(d, 0), i.setEnd(e, 0);
    var k = i.commonAncestorContainer;
    if ((a !== k && b !== k) || d.contains(e)) return g(k) ? k : f(k);
    var l = h(a);
    return l.host ? j(l.host, b) : j(a, h(b).host);
  }
  function k(a) {
  ...
  function q(a) {
    ...
    try {
      if (e(10)) {
        ...
        var d = k(a, 'top'),
          f = k(a, 'left');
        (c.top += d), (c.left += f), (c.bottom += d), (c.right += f);
      } else c = a.getBoundingClientRect();
    } catch (a) {}
    var g = {left: c.left, top: c.top, width: c.right - c.left, height: c.bottom - c.top},
  ...
  function r(a, c) {
    ...
    f && h && ((j.top = R(j.top, 0)), (j.left = R(j.left, 0)));
  ...
  function v(a, b, e, f) {
    var g = 4 < arguments.length && void 0 !== arguments[4] && arguments[4],
      h = {top: 0, left: 0},
      i = g ? u(a) : j(a, b);
    if ('viewport' === f) h = s(i, g);
    else {
      var k;
      'scrollParent' === f
        ? ((k = d(c(b))), 'BODY' === k.nodeName && (k = a.ownerDocument.documentElement))
        : 'window' === f
        ? (k = a.ownerDocument.documentElement)
        : (k = f);
      var l = r(k, i, g);
      if ('HTML' === k.nodeName && !t(i)) {
        var m = o(a.ownerDocument),
          n = m.height,
          p = m.width;
        (h.top += l.top - l.marginTop),
          (h.bottom = n + l.top),
          (h.left += l.left - l.marginLeft),
          (h.right = p + l.left);
      } else h = l;
    }
    e = e || 0;
    var q = 'number' == typeof e;
    return (
      (h.left += q ? e : e.left || 0),
      (h.top += q ? e : e.top || 0),
      (h.right -= q ? e : e.right || 0),
      (h.bottom -= q ? e : e.bottom || 0),
      h
    );
  }
  function w(a) {
  ...
  function D(a, b, c) {
    ...
    var d = B(a),
      ...
      i = f ? 'height' : 'width',
      j = f ? 'width' : 'height';
    return (e[g] = b[g] + b[i] / 2 - d[i] / 2), (e[h] = c === h ? b[h] - d[j] : b[C(h)]), e;
  }
  function E(a, b, c) {
  ...
  function F(a) {
    for (
      var b = [!1, 'ms', 'Webkit', 'Moz', 'O'], c = a.charAt(0).toUpperCase() + a.slice(1), d = 0;
      d < b.length;
      d++
    ) {
      var e = b[d],
  ...
  function L(a, b) {
    return (
      K(a).removeEventListener('resize', b.updateBound),
  ...
  function M(a, b, c) {
    var d = void 0 === c ? a : a.slice(0, z(a, 'name', c));
    return (
      d.forEach(function (a) {
        ...
        a.enabled &&
          G(c) &&
          ((b.offsets.popper = p(b.offsets.popper)), (b.offsets.reference = p(b.offsets.reference)), (b = c(b, a)));
      }),
      b
    );
  }
  ...
  function O(a, b) {
    Object.keys(b).forEach(function (c) {
      var d = '';
      -1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(c) && J(b[c]) && (d = 'px'),
        (a.style[c] = b[c] + d);
    });
  }
  function P(a, b, c, e) {
    ...
    g.addEventListener(b, c, {passive: !0}), f || P(d(g.parentNode), b, c, e), e.push(g);
  }
  function Q(a, b, c, e) {
    (c.updateBound = e), K(a).addEventListener('resize', c.updateBound, {passive: !0});
    var f = d(a);
    return P(f, 'scroll', c.updateBound, c.scrollParents), (c.scrollElement = f), (c.eventsEnabled = !0), c;
  }
  for (
    var R = Math.max,
      S = 'undefined' != typeof window && 'undefined' != typeof document,
      T = S && !!(window.MSInputMethodContext && document.documentMode),
  ...
  (a.computeAutoPlacement = x),
    (a.debounce = Z),
    (a.findIndex = z),
    (a.getBordersSize = m),
    (a.getBoundaries = v),
    (a.getBoundingClientRect = q),
    (a.getClientRect = p),
    (a.getOffsetParent = f),
    (a.getOffsetRect = A),
    (a.getOffsetRectRelativeToArbitraryNode = r),
    (a.getOuterSizes = B),
    (a.getParentNode = c),
    (a.getPopperOffsets = D),
    (a.getReferenceOffsets = E),
    (a.getScroll = k),
    (a.getScrollParent = d),
    (a.getStyleComputedProperty = b),
    (a.getSupportedPropertyName = F),
    (a.getWindowSizes = o),
    (a.isFixed = t),
    (a.isFunction = G),
    (a.isModifierEnabled = H),
    (a.isModifierRequired = I),
    (a.isNumeric = J),
    (a.removeEventListeners = L),
    (a.runModifiers = M),
    (a.setAttributes = N),
    (a.setStyles = O),
    (a.setupEventListeners = Q),
    (a['default'] = {
