...
function g(e) {
  ...
  for (var t = c(10) ? document.body : null, o = e.offsetParent || null; o === t && e.nextElementSibling; )
    o = (e = e.nextElementSibling).offsetParent;
  var n = o && o.nodeName;
  return n && 'BODY' !== n && 'HTML' !== n
    ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(o.nodeName) && 'static' === a(o, 'position')
      ? g(o)
      : o
    : e
...
function P(e, t) {
  ...
  var g = D({top: p.top - s.top - m, left: p.left - s.left - h, width: p.width, height: p.height});
  if (((g.marginTop = 0), (g.marginLeft = 0), !i && r)) {
    var u = parseFloat(l.marginTop, 10),
      b = parseFloat(l.marginLeft, 10);
    (g.top -= m - u), (g.bottom -= m - u), (g.left -= h - b), (g.right -= h - b), (g.marginTop = u), (g.marginLeft = b);
  }
  return (i && !n ? t.contains(d) : t === d && 'BODY' !== d.nodeName) && (g = E(g, t)), g;
}
function k(e) {
  var t = Math.max,
    ...
    s = o ? 0 : y(n),
    d = o ? 0 : y(n, 'left'),
    a = {top: s - i.top + i.marginTop, left: d - i.left + i.marginLeft, width: r, height: p};
  return D(a);
}
function W(e) {
  var t = e.nodeName;
...
function H(e, t, o, n) {
  ...
  if ('viewport' === n) r = k(p, i);
    ...
    var s;
    'scrollParent' === n
      ? ((s = f(l(t))), 'BODY' === s.nodeName && (s = e.ownerDocument.documentElement))
      : 'window' === n
    ...
    if ('HTML' === s.nodeName && !W(p)) {
      var a = O(e.ownerDocument),
        m = a.height,
        h = a.width;
      (r.top += d.top - d.marginTop), (r.bottom = m + d.top), (r.left += d.left - d.marginLeft), (r.right = h + d.left);
    } else r = d;
  }
  o = o || 0;
...
function U(e, t, o) {
  ...
  var n = I(e),
    ...
    d = r ? 'height' : 'width',
    a = r ? 'width' : 'height';
  return (i[p] = t[p] + t[d] / 2 - n[d] / 2), (i[s] = o === s ? t[s] - n[a] : t[R(s)]), i;
}
function Y(e, t) {
...
function j(e, t, o) {
  ...
  return (
    n.forEach(function (e) {
      ...
      e.enabled &&
        d(o) &&
        ((t.offsets.popper = D(t.offsets.popper)), (t.offsets.reference = D(t.offsets.reference)), (t = o(t, e)));
    }),
    t
  );
}
function q() {
  if (!this.state.isDestroyed) {
    ...
    (e.offsets.reference = F(this.state, this.popper, this.reference, this.options.positionFixed)),
      (e.placement = M(
...
function X(e, t, o, n) {
  ...
  r.addEventListener(t, o, {passive: !0}), i || X(f(r.parentNode), t, o, n), n.push(r);
}
function J(e, t, o, n) {
  (o.updateBound = n), _(e).addEventListener('resize', o.updateBound, {passive: !0});
  var i = f(e);
  return X(i, 'scroll', o.updateBound, o.scrollParents), (o.scrollElement = i), (o.eventsEnabled = !0), o;
}
function Q() {
...
function te(e, t) {
  Object.keys(t).forEach(function (o) {
    var n = '';
    -1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) && ee(t[o]) && (n = 'px'),
      (e.style[o] = t[o] + n);
  });
}
function oe(e, t) {
...
function ie(e, t, o, n, i) {
  var r = F(i, t, e, o.positionFixed),
    p = M(o.placement, r, t, e, o.modifiers.flip.boundariesElement, o.modifiers.flip.padding);
  return t.setAttribute('x-placement', p), te(t, {position: o.positionFixed ? 'fixed' : 'absolute'}), o;
}
function re(e, t) {
  var o = e.offsets,
    n = o.popper,
...
function se(e, t) {
  ...
  var p,
    ...
    u = z('transform');
  if (
    ((s = 'bottom' == h ? ('HTML' === a.nodeName ? -a.clientHeight + m.bottom : -l.height + m.bottom) : m.top),
    (p = 'right' == c ? ('HTML' === a.nodeName ? -a.clientWidth + m.right : -l.width + m.right) : m.left),
    d && u)
  )
    (f[u] = 'translate3d(' + p + 'px, ' + s + 'px, 0)'), (f[h] = 0), (f[c] = 0), (f.willChange = 'transform');
  else {
    var b = 'bottom' == h ? -1 : 1,
      w = 'right' == c ? -1 : 1;
...
var ce = {FLIP: 'flip', CLOCKWISE: 'clockwise', COUNTERCLOCKWISE: 'counterclockwise'};
function ge(e, t) {
  if (K(e.instance.modifiers, 'inner')) return e;
  if (e.flipped && e.placement === e.originalPlacement) return e;
  var o = H(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
  ...
  return (
    p.forEach(function (s, d) {
      ...
      (m || b || x) &&
        ...
        x && (r = le(r)),
        (e.placement = n + (r ? '-' + r : '')),
        (e.offsets.popper = C({}, e.offsets.popper, U(e.instance.popper, e.offsets.reference, e.placement))),
...
function Ee(e, t) {
  ...
  var n = z('transform'),
    ...
    s = i[n];
  (i.top = ''), (i.left = ''), (i[n] = '');
  var d = H(e.instance.popper, e.instance.reference, t.padding, o, e.positionFixed);
  ...
  var a = t.priority,
    ...
    f = {
      primary: function (e) {
        var o = l[e];
        return l[e] < d[e] && !t.escapeWithReference && (o = Math.max(l[e], d[e])), T({}, e, o);
      },
      secondary: function (e) {
        var o = 'right' === e ? 'left' : 'top',
          n = l[o];
        return (
          l[e] > d[e] && !t.escapeWithReference && (n = Math.min(l[o], d[e] - ('right' === e ? l.width : l.height))),
          T({}, o, n)
        );
      },
    };
...
var Le = {
    ...
    applyStyle: {order: 900, enabled: !0, fn: ne, onLoad: ie, gpuAcceleration: void 0},
  },
  Se = {
    placement: 'bottom',
    positionFixed: !1,
    ...
    function e(t, o) {
      ...
      L(this, e),
        ...
        Object.keys(C({}, e.Defaults.modifiers, i.modifiers)).forEach(function (t) {
          n.options.modifiers[t] = C({}, e.Defaults.modifiers[t] || {}, i.modifiers ? i.modifiers[t] : {});
        }),
...
(Te.Utils = ('undefined' == typeof window ? global : window).PopperUtils), (Te.placements = fe), (Te.Defaults = Se);
export default Te;
