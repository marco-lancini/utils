...
function c(e) {
  ...
  return n && 'BODY' !== n && 'HTML' !== n
    ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(o.nodeName) && 'static' === s(o, 'position')
      ? c(o)
      : o
    : e
...
function T(e, t, o = !1) {
  ...
  let u = L({top: p.top - d.top - m, left: p.left - d.left - c, width: p.width, height: p.height});
...
function P(e, t, o, n, i = !1) {
  ...
  if ('viewport' === n) r = D(p, i);
    ...
    let o;
    'scrollParent' === n
      ? ((o = a(f(t))), 'BODY' === o.nodeName && (o = e.ownerDocument.documentElement))
      : 'window' === n
...
function R(e, t, o) {
  ...
  return (
    n.forEach((e) => {
      ...
      e.enabled &&
        d(o) &&
        ((t.offsets.popper = L(t.offsets.popper)), (t.offsets.reference = L(t.offsets.reference)), (t = o(t, e)));
    }),
    t
  );
}
...
function q(e, t, o, n) {
  ...
  r.addEventListener(t, o, {passive: !0}), i || q(a(r.parentNode), t, o, n), n.push(r);
}
function z(e, t, o, n) {
...
function ne(e, t) {
  ...
  let u, g;
  if (
    ((g = 'bottom' == l ? ('HTML' === d.nodeName ? -d.clientHeight + a.bottom : -s.height + a.bottom) : a.top),
...
function re(e, t) {
  ...
  return (
    (w = Math.max(Math.min(i[d] - h, w), 0)), (e.arrowElement = o), (e.offsets.arrow = {[a]: Math.round(w), [l]: ''}), e
  );
}
function pe(e) {
...
function ge(e, t) {
  ...
  const l = {
    ...
    secondary(e) {
      ...
      let n = a[o];
      return (
        a[e] > s[e] && !t.escapeWithReference && (n = Math.min(a[o], s[e] - ('right' === e ? a.width : a.height))),
        {[o]: n}
      );
    },
  };
