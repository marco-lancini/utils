...
(function (global, factory) {
      ...
      if (typeof customClass[className] !== 'string' && !customClass[className].forEach) {
        return warn(
          'Invalid type of customClass.'
            ...
            .concat(_typeof(customClass[className]), '"')
        );
      }
  ...
  var renderIcon = function renderIcon(instance, params) {
    ...
    if (Object.keys(iconTypes).indexOf(params.type) !== -1) {
      ...
      error(
        'Unknown type! Expected "success", "error", "warning", "info" or "question", got "'.concat(params.type, '"')
      );
    }
  };
  ...
  var renderProgressSteps = function renderProgressSteps(instance, params) {
    ...
    var currentProgressStep = parseInt(
      params.currentProgressStep === null ? Swal.getQueueStep() : params.currentProgressStep
    );
  ...
  var handleInputOptionsAndValue = function handleInputOptionsAndValue(instance, params) {
    if (params.input === 'select' || params.input === 'radio') {
      ...
      ['text', 'email', 'number', 'tel', 'textarea'].indexOf(params.input) !== -1 &&
  ...
  var handleInputOptions = function handleInputOptions(instance, params) {
    ...
    if (isPromise(params.inputOptions)) {
      ...
      error(
        'Unexpected type of inputOptions! Expected object, Map or Promise, got '.concat(_typeof(params.inputOptions))
      );
    }
  };
