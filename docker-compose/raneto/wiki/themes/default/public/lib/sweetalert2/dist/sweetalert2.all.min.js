!(function (t, e) {
    ...
    if (
      ((function (e) {
        m(e.classList).forEach(function (t) {
          -1 === p(x).indexOf(t) && -1 === p(S).indexOf(t) && e.classList.remove(t);
        });
      })(t),
      e && e[n])
    ) {
      if ('string' != typeof e[n] && !e[n].forEach)
        return w(
          'Invalid type of customClass.'.concat(n, '! Expected string or iterable object, got "').concat(r(e[n]), '"')
        );
      rt(t, e[n]);
    }
  }
    ...
    n &&
      ((function (t, e) {
        'string' == typeof e
          ...
          : e || rt([document.documentElement, document.body], x['no-backdrop']);
      })(n, e.backdrop),
      !e.backdrop &&
        e.allowOutsideClick &&
      ...
      i.progressSteps.forEach(function (t, e) {
        ...
        if ((r.appendChild(n), e === a && rt(n, x['active-progress-step']), e !== i.progressSteps.length - 1)) {
          var o = (function (t) {
            var e = document.createElement('li');
            return (
              rt(e, x['progress-step-line']), t.progressStepsDistance && (e.style.width = t.progressStepsDistance), e
            );
          })(t);
          r.appendChild(o);
        }
  ...
  function Bt(t, e) {
    !(function (t, e) {
      ...
      T(n, 'width', e.width),
        ...
        (n.className = x.popup),
        e.toast ? (rt([document.documentElement, document.body], x['toast-shown']), rt(n, x.toast)) : rt(n, x.modal),
  ...
  function Ut() {
    ...
    t.showConfirmButton || (O(e.confirmButton), t.showCancelButton || O(e.actions)),
  ...
  function Zt(t, e, n, o) {
    n
      ...
      : (Ot().then(function () {
        ...
        Ht.keydownTarget.removeEventListener('keydown', Ht.keydownHandler, {capture: Ht.keydownListenerCapture}),
        (Ht.keydownHandlerAdded = !1)),
      e.parentNode && e.parentNode.removeChild(e),
      G() &&
        (null !== P.previousBodyPadding &&
          ((document.body.style.paddingRight = P.previousBodyPadding + 'px'), (P.previousBodyPadding = null)),
        (function () {
        ...
        'undefined' != typeof window && _t() && window.removeEventListener('resize', zt),
      ...
      at(
        ...
        [x.shown, x['height-auto'], x['no-backdrop'], x['toast-shown'], x['toast-column']]
      );
  }
  function Qt(t) {
    var e = R();
  ...
  var $t = function (t, e, n, o) {
      (Ht.swalCloseEventFinishedCallback = Zt.bind(null, t, n, ut(), o)),
    ...
    Jt = function (t, e) {
      setTimeout(function () {
        null !== e && 'function' == typeof e && e(),
          R() ||
            (function (t) {
              delete t.params, delete Ht.keydownHandler, delete Ht.keydownTarget, Yt(ht), Yt(Kt);
            })(t);
      });
    };
  function Xt(t, e, n) {
  ...
  var te = (function () {
    ...
    ee = {
      ...
      url: function (t, e) {
        return /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(t)
          ? Promise.resolve()
    ...
    !(function (e) {
      ...
      (function (t) {
        (t.target &&
          ...
          (w('Target parameter is not valid, defaulting to "body"'), (t.target = 'body'));
      })(t),
      'string' == typeof t.title && (t.title = t.title.split('\n').join('<br />')),
      lt(t);
  }
  function oe(t, e) {
    t.removeEventListener(ft, oe), (e.style.overflowY = 'auto');
  }
  function ie(t) {
    var e = H(),
      n = R();
  ...
  function re(t, e) {
    'select' === e.input || 'radio' === e.input
      ? be(t, e)
      : -1 !== ['text', 'email', 'number', 'tel', 'textarea'].indexOf(e.input) && v(e.inputValue) && ye(t, e);
  }
  function ae(t, e) {
  ...
  var fe = function (t, e) {
      ft && j(e)
        ? ((t.style.overflowY = 'hidden'), e.addEventListener(ft, oe.bind(null, e, t)))
    ...
    pe = function (t, e) {
      !(function () {
        ...
        'undefined' != typeof window && _t() && (zt(), window.addEventListener('resize', zt)),
        m(document.body.children).forEach(function (t) {
          t === H() ||
            (function (t, e) {
    ...
    be = function (e, n) {
      ...
      v(n.inputOptions)
        ...
        ? o(n.inputOptions)
        : g('Unexpected type of inputOptions! Expected object, Map or Promise, got '.concat(r(n.inputOptions)));
    },
    ye = function (e, n) {
      var o = e.getInput();
      O(o),
        ...
        !(function (t) {
          for (var e in t)
            Mt((i = e)) || w('Unknown parameter "'.concat(i, '"')),
              t.toast &&
                ((o = e), -1 !== Dt.indexOf(o) && w('The parameter "'.concat(o, '" is incompatible with toasts'))),
              Vt((n = void 0)) && h(n, Vt(n));
          var n, o, i;
        })(t),
          R() &&
            Ht.swalCloseEventFinishedCallback &&
            (Ht.swalCloseEventFinishedCallback(), delete Ht.swalCloseEventFinishedCallback),
          Ht.deferDisposalTimer && (clearTimeout(Ht.deferDisposalTimer), delete Ht.deferDisposalTimer);
        var e = s({}, It, t);
        ne(e),
          Object.freeze(e),
