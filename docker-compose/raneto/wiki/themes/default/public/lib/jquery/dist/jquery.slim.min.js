    ...
    return (
      ...
      (h = se.tokenize = function (e, t) {
        ...
        while (a) {
          ...
          (n = !1),
          (r = _.exec(a)) && ((n = r.shift()), i.push({value: n, type: r[0].replace(F, ' ')}), (a = a.slice(n.length))),
          x.filter))
            !(r = Q[o].exec(a)) ||
              (u[o] && !(r = u[o](r))) ||
        ...
        E.event.add(e, i, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[i]) {
              ...
              r.length &&
                (G.set(this, i, {value: E.event.trigger(E.extend(r[0], E.Event.prototype), r.slice(1), this)}),
          ...
          (u = a[c]),
            pe.test(u.type || '') &&
              ...
              (u.src && 'module' !== (u.type || '').toLowerCase()
                ? E._evalUrl && !u.noModule && E._evalUrl(u.src, {nonce: u.nonce || u.getAttribute('nonce')})
