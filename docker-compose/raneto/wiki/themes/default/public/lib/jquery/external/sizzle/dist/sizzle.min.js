    ...
    if (!i && ((t ? t.ownerDocument || t : N) !== p && d(t), (t = t || p), g)) {
      ...
      if (n.qsa && !A[e + ' '] && (!m || !m.test(e)) && (1 !== x || 'object' !== t.nodeName.toLowerCase())) {
        if (((y = e), (w = t), 1 === x && V.test(e))) {
          (s = t.getAttribute('id')) ? (s = s.replace(re, ie)) : t.setAttribute('id', (s = b)), (l = (h = u(e)).length);
            ...
            : function (t, n, a) {
                ...
                if (m) {
                  ...
                  if (((h = [u ? m.firstChild : m.lastChild]), u && w)) {
                    (v =
                      (p =
                        (c = (s = (f = (d = m)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] ===
                          x && c[1]) && c[2]),
                      (d = p && m.childNodes[p]);
                    ...
                    (w &&
                      (v = p =
                        (c = (s = (f = (d = t)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] ===
                          x && c[1]),
                    !1 === v)
                  )
                    while ((d = (++p && d && d[g]) || (v = p = 0) || h.pop()))
                      if (
                        ...
                        ++v &&
                        (w && ((s = (f = d[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [x, v]),
                        d === t)
                      )
                        break;
